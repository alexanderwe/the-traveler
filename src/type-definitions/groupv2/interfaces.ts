...
export interface IGroupResponse {
  readonly detail: IGroupV2;
  readonly founder: IGroupMember;
  readonly alliedIds: string[];
  readonly parentGroup: IGroupV2;
   ...
   */
  readonly currentUserMemberMap: { [key: number]: IGroupMember };
  /**
   ...
   */
  readonly currentUserPotentialMemberMap: { [key: number]: IGroupPotentialMember };
}
...
export interface IGroupV2 {
  ...
  readonly features: IGroupFeatures;
  readonly clanInfo: IGroupV2ClanInfoAndInvestment;
}
...
export interface IGroupV2ClanInfoAndInvestment {
  readonly d2ClanProgressions: { [key: number]: IDestinyProgression };
  readonly clanCallsign: string;
  readonly clanBannerData: IClanBanner;
}
...
export interface IGroupPotentialMember {
...
export interface IGroupNameSearchRequest {
...
export interface IGroupEditAction {
  readonly name: string;
  readonly about: string;
  readonly motto: string;
  readonly theme: string;
...
export interface IGroupOptionsEditAction {
  /**
   * Minimum Member Level allowed to invite new members to group
   *
   * Always Allowed: Founder, Acting Founder
...
export interface IGroupOptionalConversationAddRequest {
  readonly chatName: string;
  readonly chatSecurity: ChatSecuritySetting;
}

export interface IGroupOptionalConversationEditRequest {
  readonly chatEnabled?: boolean;
  readonly chatName: string;
  readonly chatSecurity?: number;
}

export interface IGroupBanRequest {
  readonly comment: string;
  readonly length: IgnoreLength;
}

export interface IGroupApplicationRequest {
  readonly message: string;
}

export interface IGroupApplicationListRequest {
  readonly memberships: IUserMembership[];
  readonly message: string;
}
...
export interface IGroupV2Card {
  ...
  readonly membershipOption: MembershipOption;
  readonly capabilities: Capabilities;
  readonly clanInfo: IGroupV2ClanInfo;
  readonly avatarPath: string;
  readonly theme: string;
}
 ...
 * investment data.
 */
export interface IGroupV2ClanInfo {
  readonly clanCallsign: string;
  readonly clanBannerData: IClanBanner;
}
...
export interface IGroupOptionalConversation {
  readonly groupId: string;
  readonly conversationId: string;
  readonly chatEnabled: boolean;
  readonly chatName: string;
...
export interface ISearchResultOfGroupMember {
  readonly results: IGroupMember[];
  readonly totalResults: number;
  readonly hasMore: boolean;
  readonly query: IPagedQuery;
  readonly replacementContinuationToken: string;
...
export interface IGroupMemberLeaveResult {
  readonly group: IGroupV2;
...
export interface ISearchResultOfGroupBan {
  readonly results: IGroupBan[];
  readonly totalResults: number;
  readonly hasMore: boolean;
  readonly query: IPagedQuery;
  readonly replacementContinuationToken: string;
...
export interface IGroupBan {
  readonly groupId: string;
  readonly lastModifiedBy: IUserInfoCard;
  readonly createdBy: IUserInfoCard;
...
export interface ISearchResultOfGroupMemberApplication {
  readonly results: IGroupMemberApplication[];
  readonly totalResults: number;
  readonly hasMore: boolean;
  readonly query: IPagedQuery;
  readonly replacementContinuationToken: string;
...
export interface IGroupMemberApplication {
  readonly groupId: string;
  readonly creationDate: string;
...
export interface IGroupMembershipSearchResponse {
  readonly results: IGroupMembership[];
  readonly totalResults: number;
  readonly hasMore: boolean;
  readonly query: IPagedQuery;
  readonly replacementContinuationToken: string;
...
export interface IGroupMembership {
  readonly member: IGroupMember;
  readonly group: IGroupV2;
}

export interface IGroupPotentialMembershipSearchResponse {
...
export interface IGroupPotentialMembership {
  readonly member: IGroupPotentialMember;
  readonly group: IGroupV2;
}
