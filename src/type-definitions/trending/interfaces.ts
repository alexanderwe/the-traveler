...
export interface ITrendingCategories {
  readonly categories: ITrendingCategory[];
}

export interface ITrendingCategory {
  readonly categoryName: string;
  readonly entries: ISearchResultOfTrendingEntry;
  readonly categoryId: string;
}

export interface ISearchResultOfTrendingEntry {
  readonly results: ITrendingEntry[];
 ...
 * the trending page.
 */
export interface ITrendingEntry {
   ...
   */
  readonly items: ITrendingEntry[];
  /** If the entry has a date at which it was created, this is that date. */
  readonly creationDate?: string;
}

export interface ITrendingDetail {
  readonly identifier: string;
  readonly entityType: TrendingEntryType;
  readonly news: ITrendingEntryNews;
  readonly support: ITrendingEntrySupportArticle;
  readonly destinyItem: ITrendingEntryDestinyItem;
  readonly destinyActivity: ITrendingEntryDestinyActivity;
  readonly destinyRitual: ITrendingEntryDestinyRitual;
  readonly creation: ITrendingEntryCommunityCreation;
  readonly stream: ITrendingEntryCommunityStream;
}

export interface ITrendingEntryNews {
  readonly article: IContentItemPublicContract;
}

export interface ITrendingEntrySupportArticle {
  readonly article: IContentItemPublicContract;
}

export interface ITrendingEntryDestinyItem {
  readonly itemHash: number;
}

export interface ITrendingEntryDestinyActivity {
  readonly activityHash: number;
  readonly status: IDestinyPublicActivityStatus;
}

export interface ITrendingEntryDestinyRitual {
  readonly image: string;
   ...
   */
  readonly milestoneDetails: IDestinyPublicMilestone;
  /**
   * A destiny event will not necessarily have milestone "custom content", but if it
   * does the details will be here.
   */
  readonly eventContent: IDestinyMilestoneContent;
}

export interface ITrendingEntryCommunityCreation {
...
export interface ITrendingEntryCommunityStream {
  readonly image: string;
  readonly title: string;
