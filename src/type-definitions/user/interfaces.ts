...
export interface IGeneralUser {
  ...
  readonly context: IUserToUserContext;
...
export interface IUserMembershipData {
   ...
   */
  readonly destinyMemberships: IUserInfoCard[];
  readonly bungieNetUser: IGeneralUser;
}

/** All the partnership info that's fit to expose externally, if we care to do so. */
export interface IPublicPartnershipDetail {
