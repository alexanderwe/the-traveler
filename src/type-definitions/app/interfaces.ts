...
export interface IApplication {
   ...
   */
  readonly team: IApplicationDeveloper[];
}
...
export interface IApplicationDeveloper {
  readonly role: DeveloperRole;
  readonly apiEulaVersion: number;
  readonly user: IUserInfoCard;
}
